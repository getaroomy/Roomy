...
export default function EditProfile({ params }: { params: { uid: string } }) {
	...
	return (
		<main className="min-h-screen grid-cols-1 px-24 py-12 sm:grid-cols-6">
			{/* Header */}
			<div className="pb-8 items-center col-span-full mt-2">
				<Image src={currentUser?.photoURL  || UserProfileLogo} alt="Profile picture" height={128} width={128} className="rounded-full"/>
				<h1 className=" text-2xl">{currentUser?.displayName || "This is the display name"}</h1>
			</div>
			{/* Personal Info */}
			<div id="personalInfo" className="border-b-2 border-dashed">
				...
				<div className="pb-8 col-span-full mt-2">
					...
					<label className="relative flex items-center p-2 text-sm">
						...
						<input type="checkbox" checked={showPhoneNumber} onChange={setShowPhoneNumberHandler} className="absolute left-1/2 -translate-x-1/2 w-full h-full peer appearance-none rounded-md" />
				...
				{/* Gender */}
				<div className="pb-4 col-span-full mt-2">
					<label htmlFor="gender" className="text-sm font-medium leading-6 text-gray-900">My gender is</label>
			...
			{/* Preferences */}
			<div id="preferences" className="border-b-2 border-dashed">
				<h1 className="pt-1 text-xl font-bold">Preferences</h1>
				{/* Room With Gender */}
				<div className="pb-8 col-span-full mt-2">
					<label htmlFor="gender" className="text-sm font-medium leading-6 text-gray-900">I will only room with</label>
					<div className="flex flex-col sm:flex-row py-2">
				...
				{/* Pets */}
				<div className="pb-8 col-span-full mt-2">
					<label htmlFor="havePetsCheckbox" className="text-sm font-medium leading-6 text-gray-900">Pets</label>
					<div className="flex items-center mb-4">
						...
						<label htmlFor="havePetsCheckbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I have pet(s)</label>
					</div>
					<div className="flex items-center mb-4">
						...
						<label htmlFor="fineWithHavingPetsCheckbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I&apos;m fine with my roommates having pets</label>
					</div>
				</div>
			</div>
		</main>
